...
<div class="text-center">
  ...
  <table class="tbl-detalle text-center">
     <thead>
        <tr>
          <th class="wd15 text-center">DNI</th>
          <th class="wd30 text-center">Nombres</th>
  ...
  <div class="text-center">
    <h4>¡Generaste reporte de conductores!</h4>
  </div>
</body>
</html>